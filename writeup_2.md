...
כדי לפתור את שלב 2 ולמצוא את הסיסמה הנכונה, היה צורך לבצע את הפעולה ההפוכה לזו שבוצעה בלולאת הפענוח בתוכנית — כלומר, **לבצע XOR הפוך** על מחרוזת הידועה מראש (`"into the rabbit hole"`), בעזרת סקריפט Python -
