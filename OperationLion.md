...
לכן נסיתי לחקור את הפונקציה וכשמתי breakpoint על השורה של ההשוואה בשביל לראות את התנאי. כיוון שה-breakpoint לא עבד והתוכנית ישר נסגרה. 

הבנתי שככה"נ יש פה מנגנון אנטי-דיבג.
